    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-yellow-400 to-pink-500 flex flex-col justify-center items-center text-white">
            ...
            <div className="flex space-x-4">
                <button onClick={increment} className="bg-green-500 hover:bg-green-600 ...">Increment</button>
                <button onClick={decrement} className="bg-red-500 hover:bg-red-600 ...">Decrement</button>
            </div>
